        ...
        <>
          ...
          <section className="panel-surface p-6">
            ...
            {recentUsers.length === 0 ? (
              <p className="text-sm text-zinc-500">{t("admin.dashboard.noUsers")}</p>
            ) : (
      ...
      {loading ? (
        ...
        <div className="panel-surface overflow-x-auto">
          <table className="min-w-full text-sm text-white">
            <thead className="border-b border-white/10 bg-white/3 text-left text-xs uppercase tracking-wide text-zinc-500">
              <tr>
            ...
            <tbody className="divide-y divide-white/10">
              {users.map((user) => (
                <tr key={user.user_id} className="hover:bg-white/2">
