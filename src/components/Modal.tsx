...
export function Modal({
  ...
  return (
    <dialog
      ...
      className={`m-auto block w-[calc(100%-2rem)] max-w-sm max-h-[calc(100dvh-2rem)] overflow-y-auto overscroll-contain rounded-xl border border-white/10 bg-surface p-5 text-zinc-200 shadow-xl backdrop:bg-black/60 ${
